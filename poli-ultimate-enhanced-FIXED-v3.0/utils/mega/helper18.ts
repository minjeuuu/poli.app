export const helper18 = {
  process: (data: any) => ({ ...data, processedBy: 'helper18' }),
  ...
  format: (data: any) => `Helper18: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 18,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 18 }),
