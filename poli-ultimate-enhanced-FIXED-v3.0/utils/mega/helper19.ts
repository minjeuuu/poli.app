export const helper19 = {
  process: (data: any) => ({ ...data, processedBy: 'helper19' }),
  ...
  format: (data: any) => `Helper19: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 19,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 19 }),
