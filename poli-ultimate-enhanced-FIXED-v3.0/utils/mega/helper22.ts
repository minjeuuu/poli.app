export const helper22 = {
  process: (data: any) => ({ ...data, processedBy: 'helper22' }),
  ...
  format: (data: any) => `Helper22: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 22,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 22 }),
