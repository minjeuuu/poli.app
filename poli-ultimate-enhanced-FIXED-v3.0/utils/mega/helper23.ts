export const helper23 = {
  process: (data: any) => ({ ...data, processedBy: 'helper23' }),
  ...
  format: (data: any) => `Helper23: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 23,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 23 }),
