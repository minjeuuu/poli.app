export const helper27 = {
  process: (data: any) => ({ ...data, processedBy: 'helper27' }),
  ...
  format: (data: any) => `Helper27: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 27,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 27 }),
