export const helper3 = {
  process: (data: any) => ({ ...data, processedBy: 'helper3' }),
  ...
  format: (data: any) => `Helper3: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 3,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 3 }),
