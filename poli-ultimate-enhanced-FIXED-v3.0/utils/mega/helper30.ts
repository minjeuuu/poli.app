export const helper30 = {
  process: (data: any) => ({ ...data, processedBy: 'helper30' }),
  ...
  format: (data: any) => `Helper30: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 30,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 30 }),
