export const helper31 = {
  process: (data: any) => ({ ...data, processedBy: 'helper31' }),
  ...
  format: (data: any) => `Helper31: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 31,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 31 }),
