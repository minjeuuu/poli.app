export const helper34 = {
  process: (data: any) => ({ ...data, processedBy: 'helper34' }),
  ...
  format: (data: any) => `Helper34: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 34,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 34 }),
