export const helper35 = {
  process: (data: any) => ({ ...data, processedBy: 'helper35' }),
  ...
  format: (data: any) => `Helper35: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 35,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 35 }),
