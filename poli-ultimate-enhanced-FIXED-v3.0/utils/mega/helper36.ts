export const helper36 = {
  process: (data: any) => ({ ...data, processedBy: 'helper36' }),
  ...
  format: (data: any) => `Helper36: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 36,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 36 }),
