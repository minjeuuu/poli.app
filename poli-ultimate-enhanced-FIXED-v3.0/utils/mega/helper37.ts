export const helper37 = {
  process: (data: any) => ({ ...data, processedBy: 'helper37' }),
  ...
  format: (data: any) => `Helper37: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 37,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 37 }),
