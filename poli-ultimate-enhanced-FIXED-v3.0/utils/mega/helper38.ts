export const helper38 = {
  process: (data: any) => ({ ...data, processedBy: 'helper38' }),
  ...
  format: (data: any) => `Helper38: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 38,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 38 }),
