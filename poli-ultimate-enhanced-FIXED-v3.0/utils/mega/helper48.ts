export const helper48 = {
  process: (data: any) => ({ ...data, processedBy: 'helper48' }),
  ...
  format: (data: any) => `Helper48: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 48,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 48 }),
