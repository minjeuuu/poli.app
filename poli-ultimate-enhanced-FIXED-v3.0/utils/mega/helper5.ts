export const helper5 = {
  process: (data: any) => ({ ...data, processedBy: 'helper5' }),
  ...
  format: (data: any) => `Helper5: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 5,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 5 }),
