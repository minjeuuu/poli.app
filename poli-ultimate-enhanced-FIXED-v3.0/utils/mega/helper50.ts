export const helper50 = {
  process: (data: any) => ({ ...data, processedBy: 'helper50' }),
  ...
  format: (data: any) => `Helper50: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 50,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 50 }),
