export const helper1 = {
  process: (data: any) => ({ ...data, processedBy: 'helper1' }),
  ...
  format: (data: any) => `Helper1: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 1,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 1 }),
