export const helper14 = {
  process: (data: any) => ({ ...data, processedBy: 'helper14' }),
  ...
  format: (data: any) => `Helper14: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 14,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 14 }),
