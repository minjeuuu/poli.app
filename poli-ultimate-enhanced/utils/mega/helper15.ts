export const helper15 = {
  process: (data: any) => ({ ...data, processedBy: 'helper15' }),
  ...
  format: (data: any) => `Helper15: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 15,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 15 }),
