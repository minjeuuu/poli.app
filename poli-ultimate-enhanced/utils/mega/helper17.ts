export const helper17 = {
  process: (data: any) => ({ ...data, processedBy: 'helper17' }),
  ...
  format: (data: any) => `Helper17: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 17,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 17 }),
