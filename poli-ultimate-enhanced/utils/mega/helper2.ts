export const helper2 = {
  process: (data: any) => ({ ...data, processedBy: 'helper2' }),
  ...
  format: (data: any) => `Helper2: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 2,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 2 }),
