export const helper25 = {
  process: (data: any) => ({ ...data, processedBy: 'helper25' }),
  ...
  format: (data: any) => `Helper25: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 25,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 25 }),
