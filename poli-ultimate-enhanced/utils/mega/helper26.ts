export const helper26 = {
  process: (data: any) => ({ ...data, processedBy: 'helper26' }),
  ...
  format: (data: any) => `Helper26: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 26,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 26 }),
