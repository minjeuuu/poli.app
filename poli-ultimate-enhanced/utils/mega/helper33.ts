export const helper33 = {
  process: (data: any) => ({ ...data, processedBy: 'helper33' }),
  ...
  format: (data: any) => `Helper33: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 33,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 33 }),
