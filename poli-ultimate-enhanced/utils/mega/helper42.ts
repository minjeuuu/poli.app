export const helper42 = {
  process: (data: any) => ({ ...data, processedBy: 'helper42' }),
  ...
  format: (data: any) => `Helper42: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 42,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 42 }),
