export const helper9 = {
  process: (data: any) => ({ ...data, processedBy: 'helper9' }),
  ...
  format: (data: any) => `Helper9: ${JSON.stringify(data)}`,
  calculate: (a: number, b: number) => a + b + 9,
  compare: (a: any, b: any) => JSON.stringify(a) === JSON.stringify(b),
  merge: (...args: any[]) => Object.assign({}, ...args, { helper: 9 }),
